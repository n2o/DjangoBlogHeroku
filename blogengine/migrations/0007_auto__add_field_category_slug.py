...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blogengine_category', 'slug',
                      self.gf('django.db.models.fields.SlugField')(null=True, unique=True, max_length=40, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'blogengine.category': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'null': 'True', 'unique': 'True', 'max_length': '40', 'blank': 'True'})
        },
        'blogengine.post': {
